  ...
  ?>  
    ...
    <div class="row clearfix">
      <div class="col-md-12 column">
        <a href="arsipkan.php?id=<?php echo $id; ?>"> <button type="button" name="btnsave" class="btn btn-default">
        <span class="glyphicon glyphicon-save"></span> &nbsp; Arsipkan
    ...
    <div class="row">
    <center>
      <div id="map" style="width: 1100px; height: 500px"></div></center>
       <?php
                    ...
                    <div class="x_content">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-55">
                          <div class="thumbnail">
                            <div class="image view view-first">
                              <img style="width: 100%; display: block;" src="images/1.jpg" alt="image" />
                              <div class="mask">
                                <p>Your Text</p>
                        ...
                        <div class="col-md-55">
                          <div class="thumbnail">
                            <div class="image view view-first">
                              <img style="width: 100%; display: block;" src="images/2.jpg" alt="image" />
                              <div class="mask">
                                <p>Your Text</p>
                                <div class="tools tools-bottom">
                                  <a href="#"><i class="fa fa-link"></i></a>
                            ...
                            <div class="caption">
                              <p>Membawa korban bencana ke tenda evakuasi</p>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-55">
                          <div class="thumbnail">
                            <div class="image view view-first">
                              <img style="width: 100%; display: block;" src="images/3.jpg" alt="image" />
                              <div class="mask">
                                <p>Your Text</p>
                                <div class="tools tools-bottom">
                                  <a href="#"><i class="fa fa-link"></i></a>
                        ...
                        <div class="col-md-55">
                          <div class="thumbnail">
                            <div class="image view view-first">
                              <img style="width: 100%; display: block;" src="images/5.jpg" alt="image" />
                              <div class="mask">
                                <p>Your Text</p>
                                <div class="tools tools-bottom">
                                  <a href="#"><i class="fa fa-link"></i></a>
                            ...
                            <div class="caption">
                              <p>Pasukan yang terlibat dalam evakuasi korban longsor</p>
                            </div>
                          </div>
                        </div>
                      </div>
  ...
  function initMap() {
    ...
    var map = new google.maps.Map(document.getElementById('map'), {
      zoom: 9,
      center:  new google.maps.LatLng("<?php echo $rowreg2['lat']; ?>", "<?php echo $rowreg2['lng']; ?>")
    });
