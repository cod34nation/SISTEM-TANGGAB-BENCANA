  ...
  <script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyD9tCRG-KAV35C25bvJ527azwCvuQlu6ZA"></script>
    ...
    function load() {
      var map = new google.maps.Map(document.getElementById("map"), {
        center: new google.maps.LatLng(-0.360715, 117.752418),
        zoom: 5,
        mapTypeId: 'roadmap'
      });
      ...
      downloadUrl("phpsqlajax_genxml.php", function(data) {
        ...
        for (var i = 0; i < markers.length; i++) {
          ...
          + "</b> <br/>" + "<a href='?page=detail&id="+id_bencana+"' > <button type='button' class='btn btn-primary btn-sm'>DETAIL</button></a>";
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">SIGAB Form</h4>
                    </div>
...
<div id="myModal1" class="modal fade" role="dialog">
 ...
 <?php
                      $cobareg5 = mysqli_query($koneksi, "SELECT * FROM operasi,user WHERE user.nomor_pers=operasi.nomor_pers AND operasi.nomor_pers=$idmember");  
                     ?>
                    <ul class="list-unstyled timeline widget">
                    <?php
                            while ($rowreg5 = mysqli_fetch_array($cobareg5)) {
                               # code...
                            ?>
                      <li>
                        <div class="block">
                          <div class="block_content">
                            <h2 class="title">
                              <a href="?page=detail&id=<?php echo $rowreg5['id_bencana']?>"><?php echo $rowreg5['nama_bencana']; ?></a>
                                          </h2>
                            <div class="byline">
                              <span><?php echo $rowreg5['tgl_input']; ?></span> oleh <a><?php echo $rowreg5['nama_pers']; ?></a>
                            </div>
                            <p class="excerpt"><?php echo $rowreg5['keterangan']; ?></a>
                            </p>
                          </div>
                        </div>
                      </li>
