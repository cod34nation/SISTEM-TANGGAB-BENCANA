        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><img src="../img/logoweb.png"></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <h3><?php echo $row['pangkat'];?></h3>
                <ul class="nav side-menu">
                  <li><a href="index.php"><i class="fa fa-home"></i> Halaman Utama </a>
                  </li>
                  <li><a href="?page=regional"><i class="fa fa-edit"></i> Peta Regional </a>
                  </li>
                  <li><a href="?page=arsipdata"><i class="fa fa-desktop"></i> Arsip <span class="fa fa-chevron-down"></span></a>
          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="addnew.php" class="user-profile dropdown-toggle" aria-expanded="false">
                    Tambah Data
                  </a>
                </li>
              </ul>
